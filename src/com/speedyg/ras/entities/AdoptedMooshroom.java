...
public class AdoptedMooshroom extends AdoptedAnimal {

	public AdoptedMooshroom(World world, Player owner, Location loc, long firstSpawnTime) {
		super(world, owner, loc, AdoptedType.MOOSHROOM, firstSpawnTime);
	}
