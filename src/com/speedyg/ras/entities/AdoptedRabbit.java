...
public class AdoptedRabbit extends AdoptedAnimal {

	public AdoptedRabbit(World world, Player owner, Location loc, long firstSpawnTime) {
		super(world, owner, loc, AdoptedType.RABBIT, firstSpawnTime);
	}
