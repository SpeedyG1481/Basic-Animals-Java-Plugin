...
public class AdoptedParrot extends AdoptedAnimal {

	public AdoptedParrot(World world, Player owner, Location loc, long firstSpawnTime) {
		super(world, owner, loc, AdoptedType.PARROT, firstSpawnTime);
	}
