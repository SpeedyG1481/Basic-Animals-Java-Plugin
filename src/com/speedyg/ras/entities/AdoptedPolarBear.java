...
public class AdoptedPolarBear extends AdoptedAnimal {

	public AdoptedPolarBear(World world, Player owner, Location loc, long firstSpawnTime) {
		super(world, owner, loc, AdoptedType.POLAR_BEAR, firstSpawnTime);
	}
