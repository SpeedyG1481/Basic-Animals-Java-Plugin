...
public class AdoptedCow extends AdoptedAnimal {

    public AdoptedCow(World world, Player owner, Location loc, long firstSpawnTime) {
        super(world, owner, loc, AdoptedType.COW, firstSpawnTime);
    }
