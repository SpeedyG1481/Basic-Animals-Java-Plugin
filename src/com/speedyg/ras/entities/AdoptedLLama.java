...
public class AdoptedLLama extends AdoptedAnimal {

	public AdoptedLLama(World world, Player owner, Location loc, long firstSpawnTime) {
		super(world, owner, loc, AdoptedType.LLAMA, firstSpawnTime);
	}
