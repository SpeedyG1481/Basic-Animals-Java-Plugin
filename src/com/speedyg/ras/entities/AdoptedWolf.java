...
public class AdoptedWolf extends AdoptedAnimal {

	public AdoptedWolf(World world, Player owner, Location loc, long firstSpawnTime) {
		super(world, owner, loc, AdoptedType.WOLF, firstSpawnTime);
	}
