...
public class AdoptedChicken extends AdoptedAnimal {

    public AdoptedChicken(World world, Player owner, Location loc, long firstSpawnTime) {
        super(world, owner, loc, AdoptedType.CHICKEN, firstSpawnTime);
    }
